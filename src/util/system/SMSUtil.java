...
public class SMSUtil {
    ...
    private LinkedHashMap messageMap = new LinkedHashMap() {{
    	put("qnaReply", "[iFit]\n작성하신 1:1문의의 답변이 등록되었습니다. 자세한 내용은 앱을 확인하시기 바랍니다.");
    }};
    ...
    public String send(String smsMode, String phoneNum) throws Exception{
        ...
        String msg = base64Encode(nullcheck(messageMap.get(smsMode).toString(), ""));
