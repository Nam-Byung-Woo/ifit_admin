				...
				<div class="contentBody">
					<s:form id="faq" name="faqList" cssClass="dib" method="get" namespace="/help" action="faqList" theme="simple">
						...
						<table class="table_list tc">
							<colgroup>
								<col width="20px"><col width="50px"><col width="70px"><col width="70px">
							</colgroup>
							<thead>
								<tr>
							...
							<tbody>
								...
								<s:iterator value="dataList" status="stat">
									<tr>
										<td class="center"><input type="checkbox" name="listItemCheck" class="listItemCheck" value="<s:property value="faq_seq"/>" /></td>
