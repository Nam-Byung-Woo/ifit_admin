				...
				<div class="contentBody">
					<s:form id="promotion" name="promotionList" cssClass="dib" method="get" namespace="/banner" action="promotionList" theme="simple">
						...
						<table class="table_list tc">
							<colgroup>
								<col width="70px"><col width="70px"><col width="100px"><col width="70px">
							</colgroup>
							<thead>
								<tr>
									<th scope="col">번호</th>
								...
								<s:iterator value="dataList" status="stat">
									<tr>
										...
										<td class="center">
											...
											<i class="deleteBtn fa fa-trash-o" aria-hidden="true" title="삭제" data-seq="<s:property value="pro_seq"/>" data-title="<s:property value="pro_name"/>"></i>
										</td>
									</tr>
								</s:iterator>
							</tbody>
