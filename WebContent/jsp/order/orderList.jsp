							...
							<tbody>
								...
								<s:iterator value="dataList" status="stat">
									<tr>
										...
										<td class="center"><p class="openPop pointer hoverLine" data-pop-id="orderView" data-eachOrder="<s:property value="eachOrderListToJson"/>"><s:property value="eachOrderList.get(0).p_name"/><s:if test='eachOrderList.size>1'> 외 <s:property value="eachOrderList.size-1"/>건</s:if></p></td>
										...
										<td class="center"><s:property value="order_date"/></td>
